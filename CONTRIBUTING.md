...
# Deploy the charm
juju deploy ./admission-webhook_ubuntu-20.04-amd64.charm \
    --resource oci-image=$(yq '.containers."admission-webhook".resources."oci-image"."upstream-source"' metadata.yaml)
